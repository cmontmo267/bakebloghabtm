	...
	<div id="sidebar" class="col-sm-2">
		...
		<div class="actions">
			...
			<ul class="nav nav-pills nav-stacked">
				<li class="active"><?php echo $this->Html->link(__('New Article'), array('action' => 'add'), array('class' => '')); ?></li>
                                
				<li class="dropdown">
                                         <?php 
                                            echo $this->Html->link( __('Users') . $this->Html->tag('b', '', array('class' => 'caret')), 
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><?php echo $this->Html->link(__('List'), array('controller' => 'users', 'action' => 'index'), array('class' => '')); ?></li> 
                                        <li><?php echo $this->Html->link(__('New'), array('controller' => 'users', 'action' => 'add'), array('class' => '')); ?></li>
                                    </ul>   
	...
	<tr>
		...
		<td><?php 
                    foreach ($article['Tag'] as $tag) {
                        echo $this->Html->link($tag['title'], array('controller' => 'tags', 'action' => 'view', $tag['id']), array('class' => 'label label-info')) . '&nbsp;' ;
